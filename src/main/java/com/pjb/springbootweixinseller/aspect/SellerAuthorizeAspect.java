package com.pjb.springbootweixinseller.aspect;
...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.pjb.springbootweixinseller.controller.Seller*.*(..))" +
    "&& !execution(public * com.pjb.springbootweixinseller.controller.SellerUserController.*(..))")
    public void verify() {}
